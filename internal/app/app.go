...
var App = &cli.App{
	...
	ArgsUsage:       "( InputFile [InputFile2...] | InputDir )",
	UsageText:       usage,
...
func action(ctx *cli.Context) error {
	...
	var merged []logmerger.LogItem
	var stat logmerger.Statistics
	merged, stat, err = logmerger.MergeLogs(mainPath, restPaths)
	if err != nil {
		if exitCoder, ok := err.(cli.ExitCoder); ok {
			return exitCoder
		}
...
func statToTable(st logmerger.Statistics) string {
	sb := strings.Builder{}
